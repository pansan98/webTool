...
if(!defined('WEB_TOOL__MASTER_CUSTOM_ROOT_MOD__CONTROLLER_DIR')) {
    define('WEB_TOOL__MASTER_CUSTOM_ROOT_MOD__CONTROLLER_DIR', WEB_TOOL__MASTER_CUSTOM__ROOT_MOD_DIR.'Controller/');
}


//Mod Model dir name
if(!defined('WEB_TOOL__MASTER_CUSTOM_ROOT_MOD__MODEL_DIR')) {
    define('WEB_TOOL__MASTER_CUSTOM_ROOT_MOD__MODEL_DIR', WEB_TOOL__MASTER_CUSTOM__ROOT_MOD_DIR.'Model/');
}


//Mod Model dir name
if(!defined('WEB_TOOL__MASTER_CUSTOM_ROOT_MOD__VIEW_DIR')) {
    define('WEB_TOOL__MASTER_CUSTOM_ROOT_MOD__VIEW_DIR', WEB_TOOL__MASTER_CUSTOM__ROOT_MOD_DIR.'View/');
}
