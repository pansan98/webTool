...
<?php
//Select2
//$template_js["file"][] = '<script src="/admin/vendors/select2/dist/js/select2.full.min.js"></script>';
//Cropper
//$template_js["file"][] = '<script src="/admin/vendors/cropper/dist/cropper.min.js"></script>';
//Custom
//$template_js["file"][] = '<script src="/admin/js/custom2.js"></script>';
//$content_js["file"][] = '<script src="/admin/js/custom3.js"></script>';
?>

<?php $view['slots']->stop() ?>

<?php $view['slots']->start('scripts') ?>
    <?php $view['stack']->output('scripts') ?>
    <script>
    $(function(){
        _blockManager.init({
            rootPath: '<?php echo isset($root_path) ? e($root_path) : ""; ?>',
            docPath: '<?php echo isset($document) ? e($document->getDocumentPath()) : "";?>'
        });
    });
    </script>
<?php $view['slots']->stop() ?>

<?php $view['slots']->start('block_templates') ?>
    <?php $view['stack']->output('block_templates') ?>
<?php $view['slots']->stop() ?>
