		...
		<div class="col-md-12">
			<div class="box notop">
				<div class="box-body">
					...
					<?php if (isset($meta["facility"]) AND $meta["facility"] === true): ?>
						<a href="<?php echo $meta["page"]["path"]; ?>facility/" class="btn btn-success" style="float:right;"><i class="fa fa-tags"></i> カテゴリ</a>
					<?php endif; ?>
				</div>
			</div>
		</div>
