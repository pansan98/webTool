			...
			<div class="box notop">
				<div class="box-body">
					...
					<?php if (isset($meta["category"]) AND $meta["category"] === true): ?>
						<a href="<?php echo $meta["page"]["path"]; ?>/../area/" class="btn btn-success" style="float:right;"><i class="fa fa-tags"></i> エリア管理</a>
					<?php endif; ?>
				</div>
			</div>
		</div>
...
$content_js["init"][] = <<<"EOT"
	...
	table = $('#table_id').DataTable({
		...
		aoColumns: [
			...
			{sTitle: "エリア名", mData: "category", width:"170px"
				, "render": function (data, type, row) {
					return row["category_name"];
				}
			},
			{sTitle: "エリア名", mData: "category_name", visible: false},
