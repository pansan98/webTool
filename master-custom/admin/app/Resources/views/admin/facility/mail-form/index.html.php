...
$content_js["init"][] = <<<"EOT"
	...
	table = $('#table_id').DataTable({
		...
		aoColumns: [
			...
			{sTitle: "メニュー", mData: "id",
				"render": function (data, type, row) {
					return '<ul class="list-inline text-center">' + 
					    '<li><a class="btn btn-default btn-sm" href="{$meta["page"]["path"]}' + data + '">変更</a></li>' +
					    '<li><a class="btn btn-default btn-sm" href="{$meta["page"]["path"]}' + data + '/preview">プレビュー</a></li>' + 
