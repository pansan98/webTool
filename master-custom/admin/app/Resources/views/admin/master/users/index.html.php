...
$content_js["init"][] = <<<"EOT"
	...
	table = $('#table_id').DataTable({
		...
		aoColumns: [
			...
			{sTitle: "ユーザ名", mData: "username"},
			{sTitle: "グループ", mData: "group_display_name"},
			{sTitle: "施設名", mData: "facility_name"},
			{sTitle: "メニュー", mData: "username",
				"render": function (data, type, row) {
					return '<ul class="list-inline text-center">' + 
					    '<li><a class="btn btn-default btn-sm" href="{$meta["page"]["path"]}' + data + '/edit">変更</a></li>' +
					    '<li><a class="btn btn-default btn-sm" href="{$meta["page"]["path"]}' + data + '/edit">パスワード変更</a></li>' + 
					    '<li><button class="btn btn-danger btn-sm" onclick="item_delete(' + "'{$meta["page"]["path"]}delete'" + ', \'' + data + '\')">削除</button></li>' +
					    '</ul>';
				}
			},
		]
