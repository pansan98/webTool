		...
		<dl>
			<dd>
				...
				<ul class="txt list">
					...
					?>
					<li class="no_active">
						<input type="checkbox" name="<?php echo $template->getName(); ?>[]" value="<?php echo $val->getId(); ?>" id="<?php echo ($template->getID() . "_" . $val->getId()); ?>" style="display: none;" <?php echo $checked; ?>>
						<label for="<?php echo ($template->getID() . "_" . $val->getId()); ?>">&nbsp;<?php echo $val; ?></label>
					</li>
					<?php endforeach; ?>
				</ul>
