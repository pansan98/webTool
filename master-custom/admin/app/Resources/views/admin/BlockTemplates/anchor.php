...
<div class="box-body pad contents">
	...
	<div class="input-group col-xs-12">
		...
		<?php endif; ?>
	<?php endif; ?>
		<input type="text" class="form-control" name="<?php echo $template->getName(); ?>" id="<?php echo $template->getID(); ?>" placeholder="<?php echo $template->getPlaceholder(); ?>" value="<?php echo $template->getValue(); ?>">
	</div>
	<?php if ($template->use2Column()): ?>
	</div>
	<?php endif; ?>
